...
export default function RichMailEditor({ initialJson, open, onSave }: Properties) {
    ...
    return (
        <div className="grid gap-3">
            <div className="flex flex-wrap items-center gap-2 rounded border border-slate-200 p-2">
                ...
                <IconButton label="リンク" active={editor.isActive('link')} onClick={() => setLinkDialogOpen(true)}>
